...
public class SnapshotStore
{
    ...
    private FileSnapshot ReadSnapshot(SqliteDataReader reader)
    {
        return new FileSnapshot
        {
            ...
            LastModifiedLocalUtc = DateTime.Parse(reader.GetString(4), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind),
            SizeBytesRemote = reader.IsDBNull(5) ? null : reader.GetInt64(5),
            LastModifiedRemoteUtc = reader.IsDBNull(6) ? null : DateTime.Parse(reader.GetString(6), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind),
            ETagRemote = reader.IsDBNull(7) ? null : reader.GetString(7),
            Sha256Hash = reader.IsDBNull(8) ? null : reader.GetString(8),
            LastSyncAtUtc = DateTime.Parse(reader.GetString(9), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind),
            ...
            DeletedAt = reader.IsDBNull(13) ? null : DateTime.Parse(reader.GetString(13), System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.RoundtripKind),
